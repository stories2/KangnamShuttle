exports.LoginUbikan = function (busTrackingManager, loginInfo) {
    ...
    httpRequestCallback = function(httpRequestResponse) {
        ...
        httpRequestResponse.on('end', function () {
            ...
            busTrackingManager.CheckLoggedInUbikan(httpRequestResponse.headers)
        });
...
exports.CheckLoggedInUbikan = function (ubikanLoginRequestHeaders) {
    global.logManager.PrintLogMessage("BusTrackingManager", "CheckLoggedInUbikan", "cookie val: " + ubikanLoginRequestHeaders["set-cookie"],
        global.defineManager.LOG_LEVEL_DEBUG)
}

exports.GetBusDataList = function () {
